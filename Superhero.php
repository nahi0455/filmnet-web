    ...
    <div class="movie-detail-container animate-fadeInUp">
        <div class="movie-hero">
            <div class="animate-slideInLeft">
                <img src="https://via.placeholder.com/400x600/e50914/ffffff?text=SUPERHERO" alt="Superhero Poster" class="movie-poster-large">
            </div>
            <div class="movie-details animate-slideInRight">
                <h1 class="movie-title-large">Superhero</h1>
                <div class="movie-meta">
                    <div class="meta-item">
                        <span class="meta-label">Genre</span>
                        <span class="meta-value">Action/Adventure</span>
                    </div>
                    <div class="meta-item">
                ...
                <p class="text-secondary mb-2">
                    Experience the ultimate superhero adventure filled with spectacular action sequences, incredible special effects, 
                    and a compelling story of heroism. Join our hero as they face their greatest challenge yet in this epic blockbuster.
                </p>
            </div>
        </div>
        ...
        <div class="video-section">
            ...
            <div class="video-wrapper animate-glow">
                <iframe src="https://www.youtube.com/embed/OmJ0A-h37a4?si=zyMfRCfP5Q2N9Gie" 
